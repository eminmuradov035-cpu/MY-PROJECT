...
<button className="text-center cursor-pointer text-zinc-600 font-bold hover:text-yellow-500">Don't have an account?</button>

<button className="text-center cursor-pointer text-zinc-600 font-bold hover:text-yellow-500">Forgot Password again?</button>
      </div>
    </div>
  );
};
